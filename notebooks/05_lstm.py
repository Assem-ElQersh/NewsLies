# %% [markdown]
# # 05 — LSTM baseline (E2, historical architecture preserved)
...
CFG = yaml.safe_load(open("configs/lstm.yaml"))
...
best = trainer.train(epochs=CFG["training"]["epochs"],
                     save_path="experiments/lstm_best.pt",
                     patience=CFG["training"]["patience"])

test_metrics = trainer.evaluate(test_loader)
from src.evaluation.metrics import print_metrics
print_metrics(test_metrics, "LSTM (random-split TEST)")
